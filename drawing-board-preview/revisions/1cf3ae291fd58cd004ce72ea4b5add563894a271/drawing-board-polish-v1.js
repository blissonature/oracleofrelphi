...
(function () {
  ...
  style.textContent = [
    ...
    '#shortListPanel .relphi-template-picker-trigger{position:absolute!important;right:2.22rem!important;bottom:.22rem!important;z-index:3!important;display:grid!important;place-items:center!important;width:1.9rem!important;min-width:1.9rem!important;height:1.9rem!important;min-height:1.9rem!important;padding:0!important;border:1px solid transparent!important;border-radius:7px!important;background:transparent!important;color:#81766c!important;cursor:pointer!important}',
    '#shortListPanel .relphi-template-picker-trigger:hover,#shortListPanel .relphi-template-picker-trigger:focus-visible{outline:none!important;border-color:rgba(31,27,24,.14)!important;background:rgba(31,27,24,.035)!important}',
    '#shortListPanel .relphi-template-picker-chevron{display:block;width:7px;height:7px;margin-top:-3px;border-right:1.6px solid currentColor;border-bottom:1.6px solid currentColor;transform:rotate(45deg);transform-origin:center;transition:transform .12s ease}',
    '#shortListPanel .relphi-template-picker-trigger[aria-expanded="true"] .relphi-template-picker-chevron{transform:translateY(4px) rotate(225deg)}',
