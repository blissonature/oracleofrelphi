...
(function () {
  ...
  function refreshDrawingBoardControlAssets() {
    ...
    if (link) link.href = 'drawing-board-workflow-v2.css?v=55';
  ...
  function loadEnhancements() {
    if (isTarotContext()) {
      ...
      appendScript('drawing-board-workflow-v2.js?v=109', function () {
