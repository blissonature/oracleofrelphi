...
(function () {
  ...
  function refreshDrawingBoardControlAssets() {
    ...
    if (link) link.href = 'drawing-board-workflow-v2.css?v=37';
  ...
  function loadEnhancements() {
    if (isTarotContext()) {
      ...
      appendScript('drawing-board-workflow-v2.js?v=82', function () {
    ...
    if (isPlanetaryHoursContext()) {
      ...
      appendScript('planetary-hours-moon-position-v1.js?v=2');
