...
function installStyles(){
  ...
  const style=document.createElement('style');style.id='skyVocabTabV1Styles';style.textContent=`
    ...
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-token-context [data-focus-piece="placement"].is-vocab-token-context,
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-token-context [data-focus-piece="leader"].is-vocab-token-context{filter:drop-shadow(0 0 2px rgba(255,255,255,.98)) drop-shadow(0 0 4px rgba(31,27,24,.42))!important}
    ...
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-axis-context.has-vocab-token-context .sky-foundation-sign-sector.is-vocab-token-context,
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-axis-context.has-vocab-token-context .sky-foundation-house-sector.is-vocab-token-context{filter:none!important}
    ...
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-context:not(.has-vocab-axis-context) [data-focus-piece].is-vocab-context{opacity:1!important;filter:saturate(1.18) brightness(1.03) drop-shadow(0 0 5px rgba(20,17,14,.26))!important}
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-context:not(.has-vocab-axis-context) .sky-foundation-sign-sector.is-vocab-context,
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-context:not(.has-vocab-axis-context) .sky-foundation-house-sector.is-vocab-context{opacity:1!important;fill-opacity:.78!important;filter:saturate(1.55) brightness(1.04) drop-shadow(0 0 5px rgba(20,17,14,.3))!important}
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-context:not(.has-vocab-axis-context) .sky-foundation-sign-glyph.is-vocab-context{opacity:1!important;filter:saturate(1.35) brightness(.92) drop-shadow(0 0 4px rgba(20,17,14,.22))!important}
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-context:not(.has-vocab-axis-context) [data-focus-piece].is-vocab-context-exact{filter:saturate(1.28) brightness(1.06) drop-shadow(0 0 7px rgba(20,17,14,.38))!important}
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-axis-context [data-focus-piece].is-vocab-context{opacity:1!important;filter:none!important}
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-axis-context .sky-foundation-sign-sector.is-vocab-context{fill-opacity:.82!important}
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-axis-context .sky-foundation-house-sector.is-vocab-context{fill-opacity:.5!important}
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-axis-context .sky-foundation-sign-glyph.is-vocab-context,
    #skyFoundationWheelMount>.sky-foundation-wheel.has-vocab-axis-context [data-focus-piece].is-vocab-context-exact{filter:none!important}
