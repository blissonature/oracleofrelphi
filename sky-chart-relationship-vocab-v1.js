...
function installStyles(){
  if(document.getElementById('skyRelationshipVocabV1Styles'))return;const style=document.createElement('style');style.id='skyRelationshipVocabV1Styles';style.textContent=
    ...
    '.sky-relationship-vocab-preview{display:grid!important;gap:3px!important;min-width:0;overflow:visible}.sky-relationship-vocab-preview-glyphs{display:flex;gap:3px;align-items:center;overflow:hidden}.sky-relationship-vocab-preview-token{display:inline-flex;align-items:center;justify-content:center;min-width:17px;height:17px;padding:0 2px;border-radius:999px;background:#fffdf8;box-shadow:inset 0 0 0 1px rgba(31,27,24,.1);font:800 10px/1 system-ui,sans-serif;color:#332e2a}'+
    '.sky-relationship-vocab-preview-rails{margin:0!important}.sky-relationship-vocab-scope{color:#6a6058;font:850 .62rem/1 system-ui,sans-serif;white-space:nowrap}.sky-relationship-vocab-line{position:relative}.sky-relationship-vocab-line[data-relationship-vocab-colors="true"]{padding-left:.76rem;background-image:var(--relationship-vocab-signs),var(--relationship-vocab-houses);background-size:3px 100%,3px 100%;background-position:0 0,4px 0;background-repeat:no-repeat}'+
    '.sky-foundation-relationship-row.is-relationship-vocab-peer{box-shadow:inset 0 0 0 2px rgba(31,27,24,.38);background:#fffaf2}.sky-foundation-aspect.is-relationship-vocab-peer{stroke-width:6!important;opacity:1!important;filter:drop-shadow(0 0 2px #fffdf8)}'+
