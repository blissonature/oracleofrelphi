...
(function () {
  ...
  const entries = [
    ...
    ['north-node','North Node',['north node','true node','mean node','ascending node','node','☊','no'],null,1.12,0,-0.3,'☊','symbol','400'],
    ['south-node','South Node',['south node','descending node','☋','so'],null,1.12,0,0.3,'☋','symbol','400'],
    ['lilith','Lilith',['lilith','black moon lilith','bml','⚸'],null,1.32,0,-0.55,'⚸','symbol','400'],
