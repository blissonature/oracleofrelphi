...
(function () {
  ...
  const entries = [
    ['sun','Sun',['sun','☉','⊙'],null,1.08,0,0,'☉','symbol','400'],
    ['moon','Moon',['moon','☽','☾'],null,1.12,0,0,'☽','symbol','400'],
    ['mercury','Mercury',['mercury','☿'],null,1.08,0,0,'☿','symbol','400'],
    ['venus','Venus',['venus','♀'],null,1.08,0,0,'♀','symbol','400'],
    ['mars','Mars',['mars','♂'],null,1.08,0,0,'♂','symbol','400'],
    ['jupiter','Jupiter',['jupiter','♃'],null,1.08,0,0,'♃','symbol','400'],
    ['saturn','Saturn',['saturn','♄'],null,1.08,0,0,'♄','symbol','400'],
    ['uranus','Uranus',['uranus','♅','⛢'],null,1.08,0,0,'♅','symbol','400'],
    ['neptune','Neptune',['neptune','♆'],null,1.08,0,0,'♆','symbol','400'],
    ['pluto','Pluto',['pluto','♇','⯓','pl'],null,1.08,0,0,'⯓','symbol','400'],
    ['chiron','Chiron',['chiron','⚷'],null,1.08,0,0,'⚷','symbol','400'],
    ['aries','Aries',['aries','♈'],null,1.08,0,0,'♈','symbol','400'],
    ['taurus','Taurus',['taurus','♉'],null,1.08,0,0,'♉','symbol','400'],
    ['gemini','Gemini',['gemini','♊'],'assets/zodiac-glyphs/gemini.svg',0.95,0,0,null,'circle'],
    ['cancer','Cancer',['cancer','♋'],null,1.08,0,0,'♋','symbol','400'],
    ['leo','Leo',['leo','♌'],null,1.08,0,0,'♌','symbol','400'],
    ['virgo','Virgo',['virgo','♍'],null,1.08,0,0,'♍','symbol','400'],
    ['libra','Libra',['libra','♎'],null,1.08,0,0,'♎','symbol','400'],
    ['scorpio','Scorpio',['scorpio','♏'],null,1.08,0,0,'♏','symbol','400'],
    ['sagittarius','Sagittarius',['sagittarius','♐'],null,1.08,0,0,'♐','symbol','400'],
    ['capricorn','Capricorn',['capricorn','♑'],null,1.08,0,0,'♑','symbol','400'],
    ['aquarius','Aquarius',['aquarius','♒'],null,1.08,0,0,'♒','symbol','400'],
    ['pisces','Pisces',['pisces','♓'],null,1.08,0,0,'♓','symbol','400'],
    ...
    ['quintile','Quintile',['quintile','Q','q'],'assets/aspect-glyphs/quintile.svg',0.96,0,0,null,'circle'],
    ...
    ['part-of-fortune','Part of Fortune',['part of fortune','fortune','pars fortunae','pof','⊗','pa'],null,1.28,0,0,'fortune','circle'],
