...
(function () {
  ...
  const entries = [
    ...
    ['aries','Aries',['aries','♈'],'assets/zodiac-glyphs/aries.svg',1,0,0,null,'circle'],
    ['taurus','Taurus',['taurus','♉'],'assets/zodiac-glyphs/taurus.svg',1,0,0,null,'circle'],
    ['gemini','Gemini',['gemini','♊'],'assets/zodiac-glyphs/gemini.svg',1,0,0,null,'circle'],
    ['cancer','Cancer',['cancer','♋'],'assets/zodiac-glyphs/cancer.svg',1,0,0,null,'circle'],
    ['leo','Leo',['leo','♌'],'assets/zodiac-glyphs/leo.svg',1,0,0,null,'circle'],
    ['virgo','Virgo',['virgo','♍'],'assets/zodiac-glyphs/virgo.svg',1,0,0,null,'circle'],
    ['libra','Libra',['libra','♎'],'assets/zodiac-glyphs/libra.svg',1,0,0,null,'circle'],
    ['scorpio','Scorpio',['scorpio','♏'],'assets/zodiac-glyphs/scorpio.svg',1,0,0,null,'circle'],
    ['sagittarius','Sagittarius',['sagittarius','♐'],'assets/zodiac-glyphs/sagittarius.svg',1,0,0,null,'circle'],
    ['capricorn','Capricorn',['capricorn','♑'],'assets/zodiac-glyphs/capricorn.svg',1,0,0,null,'circle'],
