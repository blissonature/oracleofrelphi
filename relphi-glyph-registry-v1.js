...
(function () {
  ...
  const entries = [
    ...
    ['asc','Ascendant',['asc','ascendant','rising','ac'],'assets/planet-glyphs/ascendant.svg',1,0,0,null,'circle','700'],
    ['dsc','Descendant',['dsc','descendant','dc'],null,1,0,0,'Dsc','letter','700'],
    ['mc','Midheaven',['mc','midheaven'],'assets/planet-glyphs/midheaven.svg',1,0,0,null,'circle','700'],
