...
(function () {
  ...
  style.textContent = [
    ...
    '.unified-sky-wheel .chart-wheel-placement-stick.has-preview-image .chart-wheel-marker-glyph,.unified-sky-wheel .chart-wheel-placement-stick.has-preview-angle-image .chart-wheel-marker-glyph{display:none!important}',
    '.unified-sky-wheel .chart-wheel-placement-stick:not(.has-preview-image):not(.has-preview-angle-image) .chart-wheel-marker-glyph{display:block!important;fill:#111!important;font-family:"Segoe UI Symbol","Noto Sans Symbols 2","Noto Sans Symbols","DejaVu Sans",sans-serif!important;font-size:13.5px!important;font-weight:900!important;text-anchor:middle!important;dominant-baseline:middle!important}',
    '.unified-sky-wheel .chart-wheel-placement-stick image.relphi-bubble-glyph-image,.unified-sky-wheel .chart-wheel-placement-stick image.relphi-angle-glyph-image{pointer-events:none!important}',
