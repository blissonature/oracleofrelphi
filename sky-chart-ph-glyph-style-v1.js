...
(function () {
  ...
  style.textContent = [
    ...
    '.unified-sky-wheel .chart-wheel-placement-stick .chart-wheel-stick{stroke:#222!important;stroke-width:1.3!important;stroke-linecap:round!important;opacity:.86!important}',
    '.unified-sky-wheel .chart-wheel-placement-stick.is-preview-active .chart-wheel-stick{stroke-width:1.95!important;opacity:1!important}',
    ...
    '.unified-sky-wheel .chart-wheel-placement-stick .chart-wheel-stick-knob{fill:#fff!important;stroke:var(--ph-marker)!important;stroke-width:2.5!important;r:19px!important;filter:none!important}',
    '.unified-sky-wheel .chart-wheel-placement-stick.is-preview-active .chart-wheel-stick-knob{stroke-width:3.2!important;filter:drop-shadow(0 1px 1.5px rgba(0,0,0,.18))!important}',
    ...
    '.unified-sky-wheel .chart-wheel-placement-stick:not(.has-preview-inline-glyph) .chart-wheel-marker-glyph{display:block!important;fill:var(--ph-marker)!important;font-family:"Segoe UI Symbol","Noto Sans Symbols 2","Noto Sans Symbols","DejaVu Sans",sans-serif!important;font-size:20px!important;font-weight:900!important;text-anchor:middle!important;dominant-baseline:central!important}',
    '.unified-sky-wheel .chart-wheel-placement-stick.has-preview-angle-text .chart-wheel-marker-glyph{display:block!important;fill:var(--ph-marker)!important;font-family:system-ui,sans-serif!important;font-size:11px!important;font-weight:900!important;letter-spacing:-.55px!important;text-anchor:middle!important;dominant-baseline:central!important}',
    ...
    '@media(max-width:600px){.unified-sky-wheel .chart-wheel-placement-stick .chart-wheel-stick-knob{r:20px!important}.unified-sky-wheel .chart-wheel-placement-stick:not(.has-preview-inline-glyph) .chart-wheel-marker-glyph{font-size:21px!important}}'
  ].join('');
