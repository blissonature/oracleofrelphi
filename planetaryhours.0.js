...
(function () {
  ...
  const state = { tz: Intl.DateTimeFormat().resolvedOptions().timeZone || 'UTC', lat: 51.4769, lon: -0.0005, useSystem: true, now: new Date(), locationName: 'Greenwich, London, UK', moonOrientation: 'auto' };
  ...
  function moonPhaseName(phase) {
    ...
    if (phase < 0.47) return 'Waning gibbous';
    if (phase < 0.53) return 'Full Moon';
    if (phase < 0.72) return 'Waxing gibbous';
