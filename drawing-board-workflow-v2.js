...
(function () {
  ...
  function organizeBoardHeader(panel) {
    ...
    move(choices, '.quick-position-sticker-toggle');
    move(choices, '.quick-reversal-toggle');
