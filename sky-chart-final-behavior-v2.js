...
(function(){
'use strict';
if(!/(^|\/)sky-chart\.html$/.test(location.pathname)||window.__relphiSkyFinalBehaviorV4)return;
window.__relphiSkyFinalBehaviorV2=true;window.__relphiSkyFinalBehaviorV3=true;window.__relphiSkyFinalBehaviorV4=true;
