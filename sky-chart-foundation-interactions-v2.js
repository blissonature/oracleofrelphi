...
(function(){
  ...
  let lockedState=null,hoverState=null,rowLockedState=null,rowHoverState=null,refreshQueued=false,selectionClearObserver=null,renderedRelationshipSignature=null,wheelOnlyExternal=false;
  ...
  function toggleExternalWheel(spec){
    ...
    lockedState=same(lockedState,next)?null:next;hoverState=null;applyState();
    if(!lockedState)wheelOnlyExternal=false;
    return!!lockedState;
  }
  function clearExternalWheel(){
    if(!wheelOnlyExternal)return false;
    lockedState=null;hoverState=null;rowLockedState=null;rowHoverState=null;applyState();wheelOnlyExternal=false;return true;
  }
