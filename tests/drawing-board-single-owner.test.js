...
assert.match(lifecycle, /\['self', transform\(\.715,\.715/);
assert.match(lifecycle, /\['house', transform\(\.715,\.49/);
assert.match(lifecycle, /\['hopes-fears', transform\(\.715,\.265/);
assert.match(lifecycle, /\['outcome', transform\(\.715,\.04/);
