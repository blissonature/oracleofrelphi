...
assert.match(lifecycle, /\['behind', transform\(\.08,\.335/);
assert.match(lifecycle, /\['self', transform\(\.689,\.715/);
assert.match(lifecycle, /\['house', transform\(\.689,\.49/);
assert.match(lifecycle, /\['hopes-fears', transform\(\.689,\.265/);
assert.match(lifecycle, /\['outcome', transform\(\.689,\.04/);
