...
assert.match(css, /@media\(min-width:701px\)\{[\s\S]*\.relphi-focus-shell\{[^}]*overflow-y:auto!important[^}]*\}[\s\S]*\.relphi-focus-main\{[^}]*min-height:min\(38rem,calc\(100dvh - 11rem\)\)!important[^}]*\}[\s\S]*\.relphi-focus-art-pane\{[^}]*min-height:min\(36rem,calc\(100dvh - 13rem\)\)!important[^}]*overflow:hidden!important[^}]*\}[\s\S]*\.relphi-focus-art-frame\{[^}]*height:min\(36rem,calc\(100dvh - 13rem\)\)!important[^}]*max-height:36rem!important/);
