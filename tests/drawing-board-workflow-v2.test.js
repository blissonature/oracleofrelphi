...
assert.match(board, /draft\.templateName='Custom'/);
assert.match(board, /templateSelect\.value=''/);
assert.equal((board.match(/markQuestionEditCustom\(drawer,draft\)/g) || []).length, 5, 'only the helper definition plus four question-list mutations should mark a preset Custom');
