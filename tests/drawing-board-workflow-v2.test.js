...
assert.match(workflow, /Spread design', 'Choose a reusable design or type position stickers for a custom one/);
assert.match(workflow, /> Show position stickers/);
