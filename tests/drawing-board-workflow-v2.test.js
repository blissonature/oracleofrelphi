...
assert.match(nav, /drawing-board-workflow-v2\.js\?v=56/);
assert.match(nav, /drawing-board-interactions-v1\.js\?v=8/);
...
assert.match(page, /drawing-board-workflow-v2\.css\?v=11/);
assert.match(page, /navloader\.js\?v=88/);
...
assert.match(interactions, /button\.textContent = entry\[2\]/);
