...
assert.match(page, /drawing-board-workflow-v2\.css\?v=25/);
...
assert.match(workflowCss, /v25 placeholder footprint = card-art footprint/);
assert.match(workflowCss, /card-row-placeholder-item>\.card-row-drop-card\{[\s\S]{0,220}width:calc\(100% - 10px\)!important[\s\S]{0,180}aspect-ratio:500\/866!important/);
assert.match(workflowCss, /card-row-placeholder-item>\.card-row-drop-card\{[\s\S]{0,420}margin-left:5px!important[\s\S]{0,90}margin-right:5px!important/);
assert.match(workflowCss, /card-row-placeholder-item\{[\s\S]{0,260}background:transparent!important[\s\S]{0,100}box-shadow:none!important/);
