...
assert.match(nav, /drawing-board-workflow-v2\.js\?v=58/);
assert.match(nav, /drawing-board-interactions-v1\.js\?v=9/);
assert.match(nav, /drawing-board-template-lifecycle-v1\.js\?v=4/);
assert.match(nav, /drawing-board-spread-prefabs-v1\.js\?v=32/);
assert.match(page, /style\.css\?v=350/);
assert.match(page, /drawing-board-workflow-v2\.css\?v=13/);
assert.match(page, /navloader\.js\?v=90/);
...
assert.match(interactions, /function topActionRow\(panel\)/);
assert.match(interactions, /drawing-board-top-actions/);
assert.match(interactions, /function historyIconSvg\(kind\)/);
assert.match(interactions, /button\.innerHTML = historyIconSvg\(entry\[1\]\)/);
assert.match(lifecycle, /function topActionRow\(root\)/);
assert.match(lifecycle, /\['drawRandomRowCard','undoShortList','redoShortList'\]/);
assert.match(lifecycle, /actions\.appendChild\(cardsOnly\)/);
...
assert.match(workflow, /topActions\.prepend\(button\)/);
