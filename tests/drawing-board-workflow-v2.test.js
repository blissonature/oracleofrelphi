...
assert.match(nav, /drawing-board-workflow-v2\.js\?v=57/);
assert.match(nav, /drawing-board-interactions-v1\.js\?v=9/);
assert.match(nav, /drawing-board-template-lifecycle-v1\.js\?v=4/);
assert.match(nav, /drawing-board-spread-prefabs-v1\.js\?v=31/);
assert.match(page, /style\.css\?v=350/);
assert.match(page, /drawing-board-workflow-v2\.css\?v=12/);
assert.match(page, /navloader\.js\?v=89/);
...
assert.match(workflowCss, /relphi-reading-options-drawer \.board-reading-toggle-stack[\s\S]{0,260}display:grid!important[\s\S]{0,160}grid-template-columns:repeat\(3,minmax\(0,1fr\)\)!important/);
assert.match(workflowCss, /relphi-reading-options-drawer \.board-reading-toggle-stack>label[\s\S]{0,520}width:100%!important/);
