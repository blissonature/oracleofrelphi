...
assert.match(nav, /drawing-board-workflow-v2\.js\?v=51/);
...
assert.match(page, /drawing-board-workflow-v2\.css\?v=5/);
assert.match(page, /navloader\.js\?v=81/);
