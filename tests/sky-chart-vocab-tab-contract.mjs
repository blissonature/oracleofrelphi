...
assert.match(html,/sky-chart-vocab-tab-v1\.js\?v=3/,'Sky Chart must load the Vocab subtab');
...
assert.match(vocab,/data-vocab-filter="nodes"/,'Vocab must expose node filtration');
assert.match(vocab,/data-vocab-filter="axes"/,'Vocab must expose axis filtration');
assert.match(vocab,/data-vocab-filter="luminaries"/,'Vocab must expose luminary filtration');
assert.match(vocab,/data-vocab-filter="planets"/,'Vocab must expose planet filtration');
assert.match(vocab,/data-vocab-filter="other"/,'Vocab must expose other-point filtration');
assert.match(vocab,/data-vocab-filter="relationships"/,'Vocab must let intrasky relationships be included or excluded');
