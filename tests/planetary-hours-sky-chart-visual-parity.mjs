...
assert.match(page,/body \+ ' ' \+ aspect\.name \+ ' ' \+ target\.name \+ ' · ' \+ referenceName/);
...
assert.match(page,/exact major transits to the saved Default sky/);
...
assert.match(page,/Ingresses, stations, conjunctions, lunations, transits to the Default sky, saved alerts, and journal activity at a glance/);
