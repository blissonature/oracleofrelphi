...
assert.match(page,/my birth chart/);
assert.match(page,/function natalChartRecord/);
assert.match(page,/function personalTransitEventsForRange/);
assert.match(page,/body \+ ' ' \+ aspect\.name \+ ' natal ' \+ target\.name/);
assert.match(page,/automatic\.concat\(personal, alerts\)/);
assert.match(page,/id=\"calendarPersonalSource\"/);
assert.match(page,/exact major transits to My birth chart/);
assert.match(page,/state\.calendarView === 'month'/);
assert.match(page,/data-calendar-month-date/);
assert.match(page,/Ingresses, stations, conjunctions, lunations, saved alerts, and journal activity at a glance/);
