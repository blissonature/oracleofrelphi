...
assert.doesNotMatch(page,/#tableSection\[data-calendar-names="false"\] \.ph-calendar-source/);
...
assert.doesNotMatch(page,/kind:'coordinate'/);
...
assert.ok(page.indexOf('id="heptagramSvg"') < page.indexOf('Where’s the Wanderer?'));
assert.ok(page.indexOf('id="moonDisc"') < page.indexOf('Where’s the Wanderer?'));
assert.ok(page.indexOf('Where’s the Wanderer?') < page.indexOf('id="tableSection"'));
assert.doesNotMatch(page,/id="calendarHourRulerName"/);
assert.doesNotMatch(page,/id="calendarHourHeptagram"/);
assert.doesNotMatch(page,/class="ph-calendar-day-context"/);
