...
(function () {
  ...
  const mythicProfiles = {
    sun: 'https://commons.wikimedia.org/wiki/Special:FilePath/Belvedere_Apollo_Pio-Clementino_Inv1015.jpg?width=240',
    moon: 'https://commons.wikimedia.org/wiki/Special:FilePath/Diane_de_Versailles_-_Mus%C3%A9e_du_Louvre_AGER_Ma_589.jpg?width=240',
    mercury: 'https://commons.wikimedia.org/wiki/Special:FilePath/Hermes_from_Agaion_241_NAMAthens.jpg?width=240',
    venus: 'https://commons.wikimedia.org/wiki/Special:FilePath/Cnidus_Aphrodite_Altemps_Inv8619.jpg?width=240',
    mars: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ares_%28Mars%29_-_the_Greek_god_of_war.jpg?width=240',
    jupiter: 'https://commons.wikimedia.org/wiki/Special:FilePath/Roman_Marble_Statue_of_Jupiter_%28Zeus%29_Accompanied_by_Eagle%2C_2nd_C._AD_%2827683776204%29.jpg?width=240',
    saturn: 'https://commons.wikimedia.org/wiki/Special:FilePath/Rubens_saturn.jpg?width=240'
  };
  ...
  function renderAnimatedHeptagram(frame, rows, dayKey, currentIdx) {
    ...
    if (el.dayRulerPortrait && mythicProfiles[dayKey]) { el.dayRulerPortrait.src = mythicProfiles[dayKey]; el.dayRulerPortrait.alt = day.name + ' profile image from Mythic Atlas'; }
