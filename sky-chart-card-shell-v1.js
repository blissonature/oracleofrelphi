...
function repair(){
  ['A','B'].forEach(slot=>{
    ...
    current.root.dataset.whereEditorExpanded=current.editor&&!current.editor.hidden?'true':'false';
  });
}
