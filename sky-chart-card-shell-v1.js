...
function disclosureMark(){return '<svg class="sky-where-when-disclosure-mark" viewBox="0 0 24 8" aria-hidden="true" focusable="false"><circle cx="5" cy="4" r="1.45"/><circle cx="12" cy="4" r="1.45"/><circle cx="19" cy="4" r="1.45"/></svg>'}
